                ...
                <div class="card-body table-responsive " >
                    ...
                    <table id="" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tr>
                            ...
                            <th>{{__('admin/vendor.Balance')}}</th>
                            <th>{{__('admin/vendor.Transactions')}}</th>
                        ...
                        @foreach ($vendors as $vendor)
                            <tr>
                                ...
                                <th>{{$vendor->email}}</th>
                                {{-- <th>
                                    <a type="button" class="btn btn-dark"   href="{{route('vendor.dashboard')}}">view</a>
                                </th> --}}
                                <th>
                                    <a type="button" class="btn btn-dark"   href="{{route('admin.view.balance',['vendor_id'=>$vendor->id])}}">{{__('admin/vendor.Show')}}</a>
                                </th>
                                <th>
                                    <a type="button" class="btn btn-dark"   href="{{route('admin.transaction',['vendor_id'=>$vendor->id,'admin'=>0])}}">{{__('admin/vendor.Show')}}</a>
                                </th>
                                <th>
                                    <center>
                                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    ...
                                                    <a class="btn btn-dark col-sm-12"  href="{{route('admin.vendor.edit', ['vendor'=>$vendor->id])}}">{{__('admin/vendor.Update')}}</a>
                                                    <form method="post" action="{{route('admin.vendor.destroy', ['vendor'=>$vendor->id])}}">
                                                        @csrf
                                                        @method('DELETE')
