...
@section("content")
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mini-stat clearfix">
                        ...
                        <p class=" mb-0 mt-2 text-muted">{{__('home.MyBalance')}} <span class="float-right"></span></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mini-stat clearfix">
                        ...
                        <div class="clearfix"></div>
                        <p class=" mb-0 mt-2 text-muted">{{__('home.MyPurchases')}}<span class="float-right"></span></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mini-stat clearfix">
                        ...
                        <div class="clearfix"></div>
                        <p class=" mb-0 mt-2 text-muted">{{__('home.AllOrders')}} <span class="float-right"></span></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mini-stat clearfix">
                        ...
                        <div class="clearfix"></div>
                        <p class=" mb-0 mt-2 text-muted">{{__('home.WishlistProducts')}} <span class="float-right"></span></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4">{{__('home.ProductsCount')}}</h4>
    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">{{__('home.LatestOrders')}}</h4>
                    ...
                    <div class="inbox-widget">
                        ...
                        <div class="text-center mt-4 pt-3">
                            <a href="#" class="btn btn-sm btn-primary waves-light waves-effect">{{__('home.LoadMore')}}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">{{__('home.LastTransactions')}} </h4>
                    ...
                    <div class="text-center mt-3">
                        <a href="#" class="btn btn-sm btn-primary">{{__('home.LoadMore')}}</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4">{{__('home.products')}}</h4>
